...
getwd()
setwd("C:/Users/lala/Dropbox/R studio")
...
women_height<-women_data$height
women_weight
women_height
...
install.packages(pkgs="tibble")
library (package="tibble")
women_data2<- tibble(height=women_height,
                    weight=women_weight)
women_data2
...
Women_height_more_than65<-subset(women_data2,height>65)
Women_height_more_than65
...
ggplot(women_data2, aes(x=height, y=weight)) + 
  geom_point()
